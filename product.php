...
if (isset($_POST['form_review'])) {
    ...
    if ($total) {
        $error_message = 'Vous avez déjà donné une note !';
    } else {
        ...
        $success_message = "L'évaluation a été soumise avec succès !";
    }
}
...
if (isset($_POST['form_add_to_cart'])) {
    ...
    //Vérifier si le nombre de quantité selectionner par le client est disponible ou pas
    if ($_POST['p_qty'] > $current_p_qty) :
        $temp_msg = 'Pardon! Il n\'y a que  ' . $current_p_qty . ' produits(s) en stokc. Veuillez choisir une quantité valide';
?>
...
<?php
        ...
        if (isset($_SESSION['cart_p_id'])) {
            ...
            if ($added == 1) {
                $error_message1 = 'Désolé !!! Le produit est déja ajouté au panier. Veuillez chosir un autre';
            } else {
                ...
                $success_message1 = 'Le produit a été ajouté avec succès!';
            }
        } else {
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="p-price">
                                    <span style="font-size:14px;">Prix du produit</span><br>
                                    <span>
                                        <?php if ($p_old_price != '') : ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#description" aria-controls="description" role="tab" data-toggle="tab">Description du produit</a></li>
                                <li role="presentation"><a href="#feature" aria-controls="feature" role="tab" data-toggle="tab">Caractérisqtiques</a></li>
                                <li role="presentation"><a href="#condition" aria-controls="condition" role="tab" data-toggle="tab">Conditions d'achats</a></li>
                                <li role="presentation"><a href="#return_policy" aria-controls="return_policy" role="tab" data-toggle="tab">Conditions de retour</a></li>
                                <!-- <li role="presentation"><a href="#review" aria-controls="review" role="tab" data-toggle="tab">Commentaires</a></li> -->
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane" id="feature" style="margin-top: -30px;">
                                    <p>
                                        <?php
                                        if ($p_feature == '') {
                                            echo 'Aucune fonctionnalités ou bienfaits trouvés';
                                        } else {
                                            echo $p_feature;
                                        }
                                        ?>
                                ...
                                <div role="tabpanel" class="tab-pane" id="condition" style="margin-top: -30px;">
                                    <p>
                                        <?php
                                        if ($p_condition == '') {
                                            echo "Conditions d'achat non trouvées";
                                        } else {
                                            echo $p_condition;
                                        }
                                        ?>
                                ...
                                <div role="tabpanel" class="tab-pane" id="return_policy" style="margin-top: -30px;">
                                    <p>
                                        <?php
                                        if ($p_return_policy == '') {
                                            echo "Conditions de retour non trouvées";
                                        } else {
                                ...
                                <div role="tabpanel" class="tab-pane" id="review" style="margin-top: -30px;">
                                    ...
                                    <div class="review-form">
                                        ...
                                        $total = $statement->rowCount();
                                        ?>
                                        <h2>Commentaires(<?php echo $total; ?>)</h2>
                                        <?php
                                        if ($total) {
                                            $j = 0;
                                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                            foreach ($result as $row) {
                                                $j++;
                                        ?>
                                                <div class="mb_10"><b><u>Commentaires <?php echo $j; ?></u></b></div>
                                                <table class="table table-bordered">
                                                    <tr>
                                                        <th style="width:170px;">Nom du client</th>
                                        ...
                                        <?php if (isset($_SESSION['customer'])) : ?>
                                            ...
                                            <?php if ($total == 0) : ?>
                                                <form action="" method="post">
                                                    ...
                                                    <input type="submit" class="btn btn-default" name="form_review" value="Envoyer">
                                                </form>
                                            <?php else : ?>
                                                <span style="color:red;">Votre note !!!</span>
                                            <?php endif; ?>


                                        <?php else : ?>
                                            <p class="error">
                                                Désolé !!! Vous devez vous connecter pour donner un avis <br>
                                                <a href="login.php" style="color:red;text-decoration: underline;">Se connecter</a>
                                            </p>
                                        <?php endif; ?>
                                    </div>
...
<div class="product bg-gray pt_70 pb_70">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    <h2>Relations produits</h2>
                    <h3>Voir tous les produits en relation </h3>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    ?>
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <p><a href="product.php?id=<?php echo $row['p_id']; ?>">Précédent</a></p>
                            </div>
                        </div>
                    <?php
                    }
