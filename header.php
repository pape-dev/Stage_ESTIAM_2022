...
// Vérification de la table des commandes et suppression de la transaction en attente datant de plus de 24 heures. Très important
$current_date_time = date('Y-m-d H:i:s');
$statement = $pdo->prepare("SELECT * FROM tbl_payment WHERE payment_status=?");
$statement->execute(array('En attente'));
$result = $statement->fetchAll(PDO::FETCH_ASSOC);
foreach ($result as $row) {
...
<head>
	...
	?>
		<title>Gestion du profil - <?php echo $meta_title_home; ?></title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
	<?php
	}
	...
	?>
		<title>Mise à jour mot de passe - <?php echo $meta_title_home; ?></title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
	<?php
	}
...
<body>
		...
		<div class="container">
			<div class="row inner">
				<div class="col-md-4 logo">
					<a href="index.php"><img src="assets/uploads/<?php echo $logo; ?>" width="150" height="300" alt="logo image"></a>
				</div>
				...
				<div class="col-md-5 right">
					<ul>
						...
						?>
							<li><i class="fa fa-user"> &nbsp</i><?php echo $_SESSION['customer']['cust_name']; ?></li>
							<li><a href="dashboard.php"><i class="fa fa-home"></i> Compte</a></li>
						<?php
						} else {
						?>
							<li><a href="login.php"><i class="fa fa-sign-in"></i> Connexion</a></li>
							<li><a href="registration.php"><i class="fa fa-user-plus"></i> Inscription</a></li>
						<?php
						}
						?>
				...
				<div class="col-md-3 search-area">
					<form class="navbar-form navbar-left" role="search" action="search-result.php" method="get">
						...
						<div class="form-group">
							<input type="text" class="form-control search-top" placeholder="Saisir un mot clé" name="search_text">
						</div>
						<button type="submit" class="btn btn-warning"><i class="fa fa-hand-o-right"></i></i></button>
					</form>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-12 pl_0 pr_0">
					<div class="menu-container">
						<div class="menu">
							<ul>
								<li><a href="index.php">Acceuil</a></a></li>
	...
	<script type="text/javascript">
		...
		(function() {
			...
			s1.async = true;
			s1.src = 'https://embed.tawk.to/630bc3e437898912e965ccde/1gbivad4t';
			s1.charset = 'UTF-8';
