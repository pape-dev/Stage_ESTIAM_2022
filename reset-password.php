...
if (time() - $saved_time > 86400) {
    $error_message2 = 'Le délai de réinitialisation du mot de passe (24 heures) a expiré. Veuillez réinitialiser votre mot de passe à nouveau.';
}
...
if (isset($_POST['form1'])) {
    ...
    if (empty($_POST['cust_new_password']) || empty($_POST['cust_re_password'])) {
        $valid = 0;
        $error_message .= 'Veuillez saisir le nouveau mot de passe et plus la confirmation.' . '\\n';
    } else {
                        ...
                        <form action="" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label for=""></label>
                                        <input type="submit" class="btn btn-primary" value="Réinitialiser" name="form1">
                                    </div>
                                </div>
                            </div>
                        </form>
