...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="product-add.php" class="btn btn-warning btn-lg">Nouveau produit</a>
	</div>
</section>
					...
					<table id="example1" class="table table-bordered table-hover table-striped">
						<thead class="thead-dark">
							<tr>
								...
								<th width="60">Prix sans promos</th>
								<th width="60">Prix avec promos</th>
								<th width="60">Quantité</th>
								<th>Gallerie</th>
								<th>Active / en attente</th>
								<th>Catégorie</th>
								...
								<tr>
									...
									<td>
										<?php if ($row['p_is_featured'] == 1) {
											echo '<span class="badge badge-success" style="background-color:orange;">Oui</span>';
										} else {
											echo '<span class="badge badge-success" style="background-color:blue;">Non</span>';
										} ?>
									</td>
									<td>
										<?php if ($row['p_is_active'] == 1) {
											echo '<span class="badge badge-success" style="background-color:black;">Oui</span>';
										} else {
											echo '<span class="badge badge-danger" style="background-color:yellow;">Non</span>';
										} ?>
									</td>
									<td><?php echo $row['tcat_name']; ?><br><?php echo $row['mcat_name']; ?><br><?php echo $row['ecat_name']; ?></td>
									<td>
										<a href="product-edit.php?id=<?php echo $row['p_id']; ?>" class="btn btn-warning btn-xs">Modifier</a> <br> <br>
										<a href="#" class="btn btn-info btn-xs" data-href="product-delete.php?id=<?php echo $row['p_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Supprimer</a>
									</td>
								</tr>
							<?php
							}
