...
if (isset($_POST['form1'])) {
    ...
    if (empty($_POST['country_id'])) {
        $valid = 0;
        $error_message .= "Sélectionner un pays<br>";
    } else {
        ...
        if ($total) {
            $valid = 0;
            $error_message .= 'Ce pays existe déja <br>';
        }
    }
    ...
    if ($valid == 1) {
        ...
        $success_message = 'Le montant de livraison a été mis à jour avec succès.';
    }
}
?>
...
<section class="content-header">
    <div class="content-header-left">
        <h1>Modification des frais</h1>
    </div>
    <div class="content-header-right">
        <a href="shipping-cost.php" class="btn btn-primary btn-sm">Liste des frais de livraisons</a>
    </div>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php if ($error_message) : ?>
                <div class="callout callout-ifon">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select name="country_id" class="form-control select2">
                                    ...
                                    foreach ($result as $row) {
                                    ?>
                                        <option value="<?php echo $row['country_id']; ?>" <?php if ($row['country_id'] == $country_id) {
                                                                                                echo 'selected';
