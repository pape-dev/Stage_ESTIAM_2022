...
if (isset($_POST['form1'])) {
    ...
    if ($valid == 1) {
        ...
        $success_message = 'Bravo !!! Mie à jour avec succès.';
    }
}
?>
...
<section class="content-header">
    ...
    <div class="content-header-right">
        <a href="end-category.php" class="btn btn-primary btn-sm">Liste des catégories</a>
    </div>
</section>
            ...
            <form class="form-horizontal" action="" method="post">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-3 control-label">Nouvelle catégorie <span>:</span></label>
                            <div class="col-sm-4">
