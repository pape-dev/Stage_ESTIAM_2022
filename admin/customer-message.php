				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Sélectionner le client <span>*</span></label>
							<div class="col-sm-4">
...
<?php if (isset($_POST['form1'])) : ?>
	<section class="content-header">
		<div class="content-header-left">
			<h1>Voir les messages des clients</h1>
		</div>
	</section>
					...
					<div class="box-body table-responsive">
						<table id="example1" class="table table-bordered table-striped">
							<thead>
								<tr>
									<th width="30">-</th>
									<th width="100">Sujets</th>
									<th width="200">Message</th>
									<th width="200">Details de la commande</th>
								</tr>
							</thead>
							<tbody>
								<?php
