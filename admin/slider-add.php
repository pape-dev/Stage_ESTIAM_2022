...
if (isset($_POST['form1'])) {
	...
	if ($valid == 1) {
		...
		$success_message = 'Votre publicité a été ajouté avec succès!';
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="slider.php" class="btn btn-primary btn-sm">Liste des pub</a>
	</div>
</section>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Plus d'infos</label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Liens </label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select name="position" class="form-control">
									...
									<option value="Center">Droite</option>
									<option value="Right">Milieu</option>
								</select>
							</div>
						</div>
						<div class="form-group">
