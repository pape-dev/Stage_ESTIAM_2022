...
if (isset($_POST['form1'])) {
	...
	if ($valid == 1) {
		...
		$success_message = 'La photo a été modifié avec succès.';
	}
}
?>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Avant</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Nouvelle <span>:</span></label>
