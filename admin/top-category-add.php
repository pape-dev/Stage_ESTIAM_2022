...
if (isset($_POST['form1'])) {
	...
	if ($valid == 1) {
		...
		$success_message = 'Une nouvelle catégorie principale a été ajouté avec succès.';
	}
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Nouvelle catégorie principale</h1>
	</div>
	<div class="content-header-right">
		<a href="top-category.php" class="btn btn-warning btn-sm">Liste des catégories principales</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="tcat_name" placeholder="Technologies">
							</div>
						</div>
						<div class="form-group">
