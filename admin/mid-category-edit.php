...
if (isset($_POST['form1'])) {
    ...
    if ($valid == 1) {
        ...
        $success_message = 'Bravo !!! Mise à jour sous-catégorie avec succès.';
    }
}
?>
...
<section class="content-header">
    ...
    <div class="content-header-right">
        <a href="mid-category.php" class="btn btn-primary btn-sm">Liste des sous-catégories</a>
    </div>
</section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Voulez-vous supprimer cette ssous-catégorie?
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-dark" data-dismiss="modal">Non</button>
                <a class="btn btn-warning btn-ok">Supprimer</a>
            </div>
        </div>
    </div>
</div>
