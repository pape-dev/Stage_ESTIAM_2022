...
if (isset($_POST['form1'])) {
	...
	if ($valid == 1) {
		...
		$success_message = 'Bravo !!! Une nouvelle partenaire a été ajouté abec succès';
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="service.php" class="btn btn-warning btn-sm">Liste des partenaires</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Nom Entreprise <span>:</span></label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Prestations <span>:</span></label>
							<div class="col-sm-6">
								<textarea class="form-control" name="content" style="height:400px;"><?php if (isset($_POST['content'])) {
																										echo $_POST['content'];
																									} ?></textarea>
							</div>
						</div>
