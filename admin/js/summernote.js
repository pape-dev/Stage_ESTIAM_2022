...
/**
 * listing all précédent siblings (until predicate hit).
 *
 * @param {Node} node
 * @param {Function} [optional] pred - predicate function
 */
...
/**
 * returns précédent boundaryPoint
 *
 * @param {BoundaryPoint} point
...
$$1.extend($$1.summernote.lang, {
    'en-US': {
        ...
        help: {
            ...
            'linkDialog.show': 'Suivant Link Dialog'
        },
        history: {
            undo: 'Undo',
            redo: 'Redo'
...
var LinkDialog = /** @class */ (function () {
    ...
    /**
     * Suivant link dialog and set event handlers on dialog controls.
     *
     * @param {Object} linkInfo
     * @return {Promise}
     */
