...
if (isset($_POST['form1'])) {
    ...
    if ($path == '') {
        $valid = 0;
        $error_message .= 'Désolé !!! Le chmaps ne doit pas être vide';
    } else {
    ...
    if ($valid == 1) {
        ...
        $success_message = 'Mise à jour avec succès';
    }
}
// Change Favicon
...
<section class="content-header">
    <div class="content-header-left">
        <marquee>
            <h1>Paramètre générale de la boutique</h1>
        </marquee>
    </div>
</section>
        ...
        <div class="col-md-12">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#tab_2" data-toggle="tab">Marque</a></li>
                    <li><a href="#tab_3" data-toggle="tab">Pied de page & Contact</a></li>
                    <li><a href="#tab_4" data-toggle="tab">Message d'aide</a></li>
                    <li><a href="#tab_5" data-toggle="tab">Affichage des Produits</a></li>
                    <li><a href="#tab_6" data-toggle="tab">Paramètre P.Accueil</a></li>
                    <li><a href="#tab_7" data-toggle="tab">Paramètre Bannière</a></li>
                    <li><a href="#tab_9" data-toggle="tab">Paramètre paiement</a></li>
                    <li><a href="#tab_10" data-toggle="tab">Scripts (head & body)</a></li>
                ...
                <div class="tab-content">
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Nouveau logo</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                    ...
                    <div class="tab-pane" id="tab_2">
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Marque</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="../assets/uploads/<?php echo $favicon; ?>" class="existing-photo" style="height:40px;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Nouvelle marque</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                        ...
                        <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Adresse de la boutique </label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Maps </label>
                                        <div class="col-sm-9">
                        ...
                        <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Subjet</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Mot de passe oublié</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <button type="submit" class="btn btn-warning pull-left" name="form4">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Nombre de produits en Gallerie<span>:</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_featured_product_home" value="<?php echo $total_featured_product_home; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Nombre des derniers produits<span>:</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_latest_product_home" value="<?php echo $total_latest_product_home; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Nombre de produits populaires<span>:</span></label>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-warning pull-left" name="form5">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" id="tab_6">
                        ...
                        <h3>Affichage des sections</h3>
                        <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Partenaires </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Bienvenue </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Gallerie</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Derniers produits </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Produits populaires </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-warning pull-left" name="form6_0">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Mots-clés </label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-warning pull-left" name="form6">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-warning pull-left" name="form6_4">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-warning pull-left" name="form6_5">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-warning pull-left" name="form6_6">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Newsletter</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-warning pull-left" name="form6_3">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <td style="width:50%">
                                        <h4>Page de connexionr</h4>
                                        Choix photo<input type="file" name="photo">
                                        <input type="submit" class="btn btn-warning btn-xs" value="Modifier" style="margin-top:10px;" name="form7_1">
                                    </td>
                                </form>
                            </tr>
                            <tr>
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <td style="width:50%">
                                        ...
                                        Choix photo<input type="file" name="photo">
                                        <input type="submit" class="btn btn-warning btn-xs" value="Modifier" style="margin-top:10px;" name="form7_2">
                                    </td>
                                </form>
                            </tr>
                            <tr>
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <td style="width:50%">
                                        ...
                                        Choix photo<input type="file" name="photo">
                                        <input type="submit" class="btn btn-warning btn-xs" value="Modifier" style="margin-top:10px;" name="form7_3">
                                    </td>
                                </form>
                            </tr>
                            <tr>
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <td style="width:50%">
                                        ...
                                        Choix photo<input type="file" name="photo">
                                        <input type="submit" class="btn btn-warning btn-xs" value="Modifier" style="margin-top:10px;" name="form7_4">
                                    </td>
                                </form>
                            </tr>
                            ...
                            <tr>
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <td style="width:50%">
                                        <h4>Page de recherhce</h4>
                                        Choix photo<input type="file" name="photo">
                                        <input type="submit" class="btn btn-warning btn-xs" value="Modifier" style="margin-top:10px;" name="form7_6">
                                    </td>
                                </form>
                            </tr>
                            ...
                            <tr>
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <td style="width:50%">
                                        <h4>Panier</h4>
                                        Choix photo<input type="file" name="photo">
                                        <input type="submit" class="btn btn-warning btn-xs" value="Modifier" style="margin-top:10px;" name="form7_7">
                                    </td>
                                </form>
                            </tr>
                            ...
                            <tr>
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <td style="width:50%">
                                        <h4>Paiement</h4>
                                        Choix photo<input type="file" name="photo">
                                        <input type="submit" class="btn btn-warning btn-xs" value="Modifier" style="margin-top:10px;" name="form7_8">
                                    </td>
                                </form>
                            </tr>
                            ...
                            <tr>
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <td style="width:50%">
                                        <h4>Catégories</h4>
                                        Choix photo<input type="file" name="photo">
                                        <input type="submit" class="btn btn-warning btn-xs" value="Modifier" style="margin-top:10px;" name="form7_9">
                                    </td>
                                </form>
                            </tr>
                    ...
                    <div class="tab-pane" id="tab_9">
                        <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">PayPal_Email </label>
                                        <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Infos Banques </label>
                                        <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-warning pull-left" name="form9">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" id="tab_10">
                        <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Script avant la balise &lt;/head&gt; </label>
                                        <div class="col-sm-8">
                                            <textarea name="before_head" class="form-control" cols="30" rows="10"><?php echo $before_head; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Script avant la balise &lt;body&gt; </label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-warning pull-left" name="form10">Modifier</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
